...
class TestSr25519: XCTestCase {
    private let testValues = (0..<Constants.testsCount).compactMap { _ in UUID().uuidString.data(using: .utf8)?[0..<32] }
    ...
    func testSr25519() throws {
        ...
        for testValue in testValues {
            ...
            let isValid = try testValue.sr25519.verify(signature: keyPair.signature, publicKey: keyPair.publicKey)
