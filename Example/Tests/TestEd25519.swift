...
class TestEd25519: XCTestCase {
    ...
    private let testValues = (0..<Constants.testsCount/10).compactMap { _ in UUID().uuidString.data(using: .utf8) }
    ...
    func testKeyPair() throws {
        ...
        let keyPair = try KeyPairFactory.ed25519.load(seedOrPrivateKey: seed)
